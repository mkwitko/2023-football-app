            ...
            <ModalProsper.Modal open={open} setOpen={setOpen}>
              ...
              <ModalProsper.ModalContent className="w-[80%] p-0 rounded-[0.625rem] gap-0">
                ...
                <div className="flex items-end justify-center w-full p-4">
                  <p className="text-[1.5rem] leading-[3.5rem] text-primary font-[900]">
                    R$
                  </p>
                  <input
                    step="0.5"
                  ...
                  <div className="flex items-center justify-between">
                    <button
                      ...
                      onClick={() => {
                        ...
                        } else handleComment(true)
                      }}
                      className="disabled:opacity-50 flex-1 bg-primary text-white p-4 rounded-ee-[0.625rem] font-bold"
                      type="button"
                    >
                      Confirmar
                    </button>
