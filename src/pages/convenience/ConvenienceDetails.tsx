        ...
        <IonContent fullscreen>
            {propaganda.hook.current && (
                <div className='flex flex-col p-8 gap-4'>
                    <img className='w-32 md:w-[24rem] md:my-8 h-auto' src={propaganda.hook.current.logoPath} alt="" />
                    <p className='text-primary font-bold border-b pb-4 border-primary text-[1rem] md:text-[2rem]'>{propaganda.hook.current.title}</p>
                    <div className='flex gap-8 h-[15rem]'>
                        <img className='aspect-square object-cover w-full h-full rounded-[1rem]' src={propaganda.hook.current.imagePath} alt="" />
                    </div>
                    <div className='text-primary-900 text-[1rem] md:text-[1.5rem]'
                                        ...
                                        <ModalProsper.ModalContent className='w-4/5 rounded-[0.625rem] gap-0 p-0'>
                                            ...
                                            <div className='flex flex-col gap-4 p-4 items-center justify-center'>
                                                ...
                                                <div className='border-2 p-3 md:mt-4 md:mb-8 rounded-[0.625rem]'>
                                                    <QRCode value={propaganda.hook.current.qrCode} size={isMd ? 240 : 180} />
                                                </div>
                                            </div>
