                    ...
                    <div className="w-full h-[30vh] md:h-auto">
                        ...
                        <div className="p-4 pb-40 md:px-12">
                            <div className='flex items-center gap-2 mb-2'>
                                <img className='rounded-full h-8 w-8 md:h-16 md:w-16' src={news.author && news.author.avatar ? news.author.avatar : 'https://shorturl.at/qGJRY'} alt="" />
                                <div className='flex flex-col'>
                                <span className='text-primary-900 text-[0.75rem] md:text-[1.5rem] font-bold'>{news.author && news.author.name ? news.author.name : 'Autor Desconhecido'}</span>
