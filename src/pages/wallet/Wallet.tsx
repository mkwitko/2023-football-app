    ...
    <IonContent fullscreen>
      <div className="flex flex-col p-8 gap-8">
        <div className="flex flex-col">
          <p className="text-primary font-bold text-[1rem] md:text-[1.5rem]">
            Carteira
          </p>
          <p className="text-[0.75rem] md:text-[1.5rem]">
            ...
            <a
              ...
              className="text-[0.75rem] md:text-[1.5rem] text-primary"
            >
              leia elas aqui.
            </a>
          </p>
        ...
        <div className="flex items-center w-full justify-between">
          ...
          <p className="text-primary font-bold text-[1rem] md:text-[1.5rem]">
            R$
            {wallets.hook.data?.balance
              ? (+wallets.hook.data.balance).toFixed(2)
              : 0}
          </p>
        </div>
        <div className="flex flex-col gap-8">
          <div>
            ...
            <div className="flex items-center w-full justify-between">
              <p className="text-primary-900 text-[0.75rem] md:text-[1.5rem] font-bold w-full">
                Quantia a ser adicionada
              </p>
              <input
                step="0.5"
                className="p-2 pb-0 w-[45%] text-end bg-transparent font-bold text-primary-900 text-[1rem] md:text-[1.5rem]"
                type="text"
                value={value}
                onChange={(e) => {
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              <button
                type="button"
                className="text-white font-bold h-full w-full text-[1rem] md:text-[1.5rem]"
              >
                Ir para o pagamento
              </button>
            </div>
