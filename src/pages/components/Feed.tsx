                        ...
                        <div key={`feed_${i}`}>
                            <div onClick={() => {
                                ...
                                <div className='flex items-center gap-2'>
                                    <img className='rounded-full h-8 w-8 md:h-12 md:w-12' src={feed.author && feed.author.avatar ? feed.author.avatar : 'https://shorturl.at/qGJRY'} alt="" />
                                    <div className='flex flex-col'>
                                        <span className='text-primary-900 text-[0.75rem] md:text-[1.25rem] font-bold'>{feed.author && feed.author.name ? feed.author.name : 'Autor Desconhecido'}</span>
